...
export const UNSET_GENERAL_LOADING = 'UNSET_GENERAL_LOADING'
...
export const GET_CAROUSEL_BY_ID = 'GET_CAROUSEL_BY_ID'
export const DELETE_CAROUSEL_BY_ID = 'DELETE_CAROUSEL_BY_ID'
export const CREATE_NEW_CAROUSEL = 'CREATE_NEW_CAROUSEL'
export const UPDATE_CAROUSEL = 'UPDATE_CAROUSEL'
export const CLEAR_CAROUSEL = 'CLEAR_CAROUSEL'
...
export const ADD_NEWS_VIDEO = 'ADD_NEWS_VIDEO'
...
export const TRAINING_REQUEST_SUCCESS = 'TRAINING_REQUEST_SUCCESS'
export const TRAINING_REQUEST_RESET = 'TRAINING_REQUEST_RESET'

export const GET_ALL_BULLETINS = 'GET_ALL_BULLETINS'
export const GET_BULLETIN_BY_ID = 'GET_BULLETIN_BY_ID'
export const DELETE_BULLETIN_BY_ID = 'DELETE_BULLETIN_BY_ID'
export const CREATE_NEW_BULLETIN = 'CREATE_NEW_BULLETIN'
export const UPDATE_BULLETIN = 'UPDATE_BULLETIN'
export const CLEAR_BULLETIN = 'CLEAR_BULLETIN'
...
export const GET_ALL_REPORTS_SELECTION = 'GET_ALL_REPORTS_SELECTION'
...
export const CLEAR_NEW_REPORT = 'CLEAR_NEW_REPORT'
