export const stepOne = {
  de: {
    text:
      "<b>Auf welche Art und Weise wurde die*der Journalist*in im öffentlichen Raum (z.B. auf einer Demonstration) angegriffen? Zutreffendes bitte auswählen.</b> Mehrfachauswahl möglich:",
    optionName: "platform",
    options: [
      {
...
export const stepFive = {
  de: {
    text: "<b>Für welches Medium ist die*der Journalist*in tätig?</b>",
  },
}
...
export const stepEight = {
  de: {
    text:
      "<b>Haben anwesende Zeug*innen den*die angegriffene Journalist*in vor Ort unterstützt? Bitte auswählen:</b>",
    optionName: "witness",
    options: [
      {
        text: "Ja, nämlich:",
