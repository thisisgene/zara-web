...
export const infoObj = {
  de: {
    ...
    cards: [
      {
        color: 'default',
        title: 'ZARA Trainingsangebote',
        text:
          'ZARA Training bietet unterschiedliche Trainings und Workshops zum Thema Zivilcourgage on- & offline an. Gemeinsam mit erfahrenen ZARA Trainer*innen können Sie - Erwachsene, Jugendliche, Kinder, in Ihrem Unternehmen - Gegenmaßnahmen und zivilcouragierte Handlungsoptionen erarbeiten und ausprobieren.',
        link: 'training',
        linkText: 'ZARA Trainingsangebote'
      },
      {
        color: 'default',
      ...
      },
      {
        ...
        title: 'Z’RUCKRED’N',
        text:
          'Z’ruckred’n ist ein Handbuch zur Argumentation gegen vorurteilsbehaftete Parolen von Dieter Schindlauer, ZARA Geschäftsführer, und Karin Bischof, ZARA Trainerin und Fortbildungs- und Evaluierungsexpertin in den Bereichen Gleichstellung, Sensibilsierung, Anti-Diskirminierung/Rassismus und Homophobie.<br><br>Das Handbuch beruht auf der mehrjährigen praktischen Arbeit der Autor*innen. So fokussiert das Handbuch auf Argumentationstechniken und -strategien, die praxiserprobt sich und wieder Lust machen sollen, den einen oder anderen Sager nicht unwidersprochen stehen zu lassen. Das Handbuch soll Neugierde wecken und Sie dabei stärken, intensive und schwierige Gespräche meistern zu können.',
        linkPath: 'external',
        link:
          'http://www.sinnfabrik.at/wp-content/uploads/zruckredn_Argumentationshandbuch.pdf',
        linkText: 'Los geht’s! Mischen Sie mit!'
      },
      {
        color: 'default',
        title:
