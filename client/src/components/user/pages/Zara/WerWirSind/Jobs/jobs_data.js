...
export const jobData = [
  {
    id: 'Mitarbeiter_in__der_Oeffentlichkeitsarbeit_Feb2019',
    category: 'job',

    de: {
      title: 'Ausschreibung: Mitarbeiter*in der Öffentlichkeitsarbeit für ZARA',
      shortDescription:
        '<p><strong>Wir suchen Verstärkung</strong></p><p>Der Verein ZARA – Zivilcourage und Anti-Rassismus-Arbeit bietet seit dem Jahr 2000 kostenlose Beratung für Betroffene und Zeug*innen von Rassismus an und betreibt seit 2017 die Beratungsstelle #GegenHassimNetz.</p>',
      content:
