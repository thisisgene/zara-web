...
import { heroData, longText } from './TrainingAdults_data'
...
class TrainingAdults extends Component {
  render() {
        ...
        {lang && (
          <div>
            ...
            >
              {lang === 'de' ? (
                <h3>
                  ZARA Training bietet folgende fünf Workshopformate für
                  Erwachsene an:
                </h3>
              ) : (
                <h3>
...
export default withLocalize(TrainingAdults)
