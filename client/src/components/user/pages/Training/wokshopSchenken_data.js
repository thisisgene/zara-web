export const heroData = {
  ...
  de: {
    ...
    text:
      'Schulen und Vereine aus ganz Österreich fragen uns regelmäßig um Workshops an. Leider fehlen ihnen jedoch oft die nötigen Ressourcen, um einen zweiteiligen Workshop vor Ort zu finanzieren. Deshalb gibt es nun die Möglichkeit für Privatpersonen, Verbände und Wirtschaftstreibende, Patenschaften zu übernehmen oder "Bausteine" für Workshops zu sponsern.',
  },
  en: {
    title: 'Workshop schenken',
    text:
...
export const longText3 = {
  de: {
    text:
      'Für Patenschaften und "Bausteine" bitten wir Sie um eine Überweisung mit dem Betreff "Workshop schenken" an:<br />ZARA Training<br />Erste Bank<br />IBAN: AT52 2011 1824 4000 5900<br />BIC: GIBAATWWXXX<br /><br /><b>Wir sagen Danke!</b><br />Als Dank werden Sie, wenn gewünscht, auf der ZARA-Homepage und im ZARA-Newsletter genannt.',
  },
  en: {
    text:
      'Für Patenschaften und "Bausteine" bitten wir Sie um eine Überweisung mit dem Betreff "Workshop schenken" an:<br />ZARA Training<br />Erste Bank<br />IBAN: AT52 2011 1824 4000 5900<br />BIC: GIBAATWWXXX<br /><br /><b>Wir sagen Danke!</b><br />Als Dank werden Sie, wenn gewünscht, auf der ZARA-Homepage und im ZARA-Newsletter genannt.',
