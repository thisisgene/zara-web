...
import { getRect, withScroll, createBox, offset, getBox, expand, calculateBox } from 'css-box-model';
...
var getFrame = function getFrame(droppable) {
  var frame = droppable.frame;
  !frame ? process.env.NODE_ENV !== "production" ? invariant(false, 'Droppable must be a scroll container to allow dynamic changes') : invariant(false) : void 0;
  return frame;
};
