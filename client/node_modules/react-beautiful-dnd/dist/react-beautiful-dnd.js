(function (global, factory) {
	...
	*/
	...
	var getFrame = function getFrame(droppable) {
	  var frame = droppable.frame;
	  !frame ? invariant(false, 'Droppable must be a scroll container to allow dynamic changes') : void 0;
	  return frame;
	};
	...
	var shouldCancel = function shouldCancel(action) {
	  return action.type === 'DROP_ANIMATE' || action.type === 'DROP' || action.type === 'DROP_COMPLETE' || action.type === 'COLLECTION_STARTING';
	};
	...
	var getY = function getY(container, distance$$1) {
	...
	var getX = function getX(container, distance$$1) {
	...
	var getRequiredScroll = function getRequiredScroll(_ref2) {
	  ...
	  var y = getY(container, distance$$1);
	  var x = getX(container, distance$$1);
